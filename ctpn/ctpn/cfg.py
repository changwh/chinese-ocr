...
#     MIN_SIZE_SIM=0.6
    ...
    MAX_HORIZONTAL_GAP=16           # 水平方向最大间隔（框与框之间的合并）        TODO:finetune   50     16
    TEXT_PROPOSALS_MIN_SCORE=0.7    # 判断一行是否为文字的评分阈值
    TEXT_PROPOSALS_NMS_THRESH=0.2
    MIN_NUM_PROPOSALS=4             # min count of proposals                TODO:finetune   0       4
    MIN_V_OVERLAPS=0.7              # 垂直方向最小交并比(用于拼接文本行)        TODO:finetune   0.7     0.7
    MIN_SIZE_SIM = 0.83             # 推荐框大小相似度最小值(用于拼接文本行)      TODO:finetune   0.7    0.83